...
const Meteos: Record<MeteosEnum, Meteo> = {
    [MeteosEnum.PLUIE]: new Meteo(MeteosEnum.PLUIE,
        "La pluie s'abat avec force sur Astrub et les enfants se réfugient chez eux. Les gouttes tombent en cadence, transformant les terres en un paysage fertile et vivant.",
        [
            {
    ...
    [MeteosEnum.BRUME_EPAISSE]: new Meteo(MeteosEnum.BRUME_EPAISSE,
        "Une épaisse nappe de brume enveloppe Astrub, plongeant les terres dans une ambiance silencieuse. Malgré ce climat, les récolteurs doivent continuer leurs activités",
        [
            {
    ...
    [MeteosEnum.VENT_FORT]: new Meteo(MeteosEnum.VENT_FORT,
        "Les rafales se déchainent sur Astrub, emportant tout sur leur passage. Ce Tumulte, certainement causé par une déesse malicieuse, complique le travail des récolteurs.",
        [
            {
    ...
    [MeteosEnum.GEL]: new Meteo(MeteosEnum.GEL,
        "Une vague glaciale s'abat sur Astrub, transformant la région en un paysage figé. Le froid mordant détruit les récoltes et les habitants restent au chaud chez eux.",
        [
            {
    ...
    [MeteosEnum.CANICULE]: new Meteo(MeteosEnum.CANICULE,
        "Une chaleur étouffante s'installe sur Astrub, rendant l'air lourd et pesant.",
        [
            {
    ...
    [MeteosEnum.SOLEIL]: new Meteo(MeteosEnum.SOLEIL,
        "Le soleil illumine le ciel d'Astrub. Les enfants jouent dehors et certains en profitent pour se promener, faire un peu de bricolage... une journée parfaite !",
        []),
    [MeteosEnum.SILVOSSE]: new Meteo(MeteosEnum.SILVOSSE,
        "Le Protecteur de Flovor foule à nouveau le sol du Monde des Douze et gare aux bûcherons imprudents qui croiseront son chemin !",
        [
            {
                description: "",
                job: JobEnum.BUCHERON,
    ...
    [MeteosEnum.ULGRUDE]: new Meteo(MeteosEnum.ULGRUDE,
        "Les sautes d'humeur du Protecteur de Martalo sont aussi imprévisibles que dangereuses. Nul n'est à l'abri d'un coup de foudre.",
        [
            {
                description: "",
                job: JobEnum.PECHEUR,
    ...
    [MeteosEnum.REVERDIE_SILOUATE]: new Meteo(MeteosEnum.REVERDIE_SILOUATE,
        "Le souffle dégivrant du Protecteur d'Aperirel se mêle aux vents réchauffés et donne un coup de fouet bienfaisant à ceux qui œuvrent à l'air libre.",
        [
            {
                description: "",
                job: JobEnum.PAYSAN,
    ...
    [MeteosEnum.VOYEURISME_HECATE]: new Meteo(MeteosEnum.VOYEURISME_HECATE,
        "Quiconque s'aventure hors de chez soi aujourd'hui a la désagréable impression qu'on l'épie.",
        [
            {description: "", job: JobEnum.PECHEUR, value: -5},
            {description: "", job: JobEnum.BUCHERON, value: -5},
            {description: "", job: JobEnum.ALCHIMISTE, value: -5},
