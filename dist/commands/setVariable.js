...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'Salon des anniversaires', value: 'birthdayChannel' }, { name: 'Salon debug', value: 'debugChannel' }, { name: 'Salon évènements', value: 'eventsChannel' }, { name: 'Salon du RP', value: 'rp_channel' }, { name: 'Rôle alerte RP générale', value: 'alerte_rp_generale' }, { name: 'Rôle alerte RP serveur', value: 'alerte_rp_serveur' }, { name: 'Rôle alerte évènements générale', value: 'alerte_event_generale' }, { name: 'Rôle alerte évènements serveur', value: 'alerte_event_serveur' }, { name: "Salon d'accueil", value: "welcomeChannel" }))
